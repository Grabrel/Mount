(() => {
  ...
  async function createProfile() {
    ...
    const existingLocalAuth = readLocalAuth();
    if (existingLocalAuth && normalizeAccessUsername(existingLocalAuth.username) === normalizeAccessUsername(username) && state.profile) {
      return setupError("Esse nome de usuário já está associado a uma conta neste navegador. Volte para Entrar.");
    }
